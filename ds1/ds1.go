...
func (ds1 *DS1) Unmarshal(fileData []byte) (*DS1, error) {
	...
	stream := tool.CreateStreamReader(fileData)
...
func (ds1 *DS1) loadHeader(br *tool.StreamReader) error {
	var err error
...
func (ds1 *DS1) loadBody(stream *tool.StreamReader) error {
...
func (ds1 *DS1) loadFileList(br *tool.StreamReader) error {
...
func (ds1 *DS1) loadObjects(br *tool.StreamReader) error {
...
func (ds1 *DS1) loadSubstitutions(br *tool.StreamReader) error {
	var err error
...
func (ds1 *DS1) loadNPCs(br *tool.StreamReader) error {
	var err error
...
func (ds1 *DS1) loadNpcPaths(br *tool.StreamReader, objIdx, numPaths int) error {
...
func (ds1 *DS1) loadLayerStreams(br *tool.StreamReader) error {
	dirLookup := []int32{
